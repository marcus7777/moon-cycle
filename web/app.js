...
(() => {
  ...
  // ==========================================
  const IFS_PROMPTS = [
    { title: "New Moon (Invitation)", prompt: "The moon rests in darkness again. I wonder—what Part within me is already awake, quietly waiting to be noticed? Simply say, 'I see you. There’s no rush, no demand—just space. Would you like to walk this cycle with me?'" },
    { title: "Tending the Spark", prompt: "The faintest light returns. Is there a Part that feels hesitant to step forward, unsure if it’s safe to be seen? Offer a quiet invitation: 'You don’t have to be ready. Just being here is enough. I’m listening'?" },
    { title: "Gentle Momentum", prompt: "The light barely visible. Which Part is eager to push forward, and which one hesitates? can you write from the one that needs to talk most?" },
    { title: "Holding Space", prompt: "The light is still so soft. Is there a Part that’s been overlooked, not because it’s loud, but because it’s been quiet for so long? Gently say, 'I don’t need you to prove your worth. You belong here, just as you are'?" },
    { title: "Soft Holding", prompt: "The moon’s glow is still tender. Is there a Part that wants to withdraw, to wait until things feel safer? Can we simply keep the space warm—no pressure, no push—just a quiet 'I’m here' to every part within?" },
    { title: "Whispers of Alignment", prompt: "The moon carries a little more light tonight. Is there a Part softly tugging my attention—maybe one I’ve overlooked? Can we lean in with kindness and ask, 'What do you need for me to hear you?'" },
    { title: "Bridging Inner Worlds", prompt: "The light is growing, and so is the pull toward action. Are any Parts starting to align around the intention, while others still linger in doubt? Welcome both—inviting movement without leaving anyone behind?" },
    { title: "Tending the Spark", prompt: "The moon is finding its shape, and so am I. Is there a Part that’s starting to believe in this path?  gently celebrate that flicker of faith—without rushing ahead—just tending the spark with care?" },
    ...
    { title: "Day After Waxing (Balancing Effort)", prompt: "As action builds, am I noticing any Parts taking on too much? pause and ask, 'Who needs relief so we can move forward together—not just pushed by the busiest Parts?'" },
    { title: "Mid-Waxing (Inviting Collaboration)", prompt: "The moon grows fuller, and so does the call to act. Are there Parts that have been quiet—maybe creative or playful ones—waiting to contribute? Gently invite them in, so growth doesn’t just come from effort, but from aliveness?" },
    { title: "Approaching Fullness (Holding Tension)", prompt: "The light is nearly full, and so is my inner world. Are there Parts in conflict—one pushing forward, another pulling back? Hold the tension without needing to fix it, letting wholeness include both?" },
    { title: "Deepening Light (Welcoming the Edges)", prompt: "The fullness is near, and so is the intensity. Are there Parts I’ve been avoiding—maybe too loud, too raw, or too tender? Turn toward them not to change them, but to say, 'You belong here too'?" },
    { title: "Near the Peak (Softening the Edges)", prompt: "The light is almost full, and so is the pressure. Is there a Part trying to 'get it right' for everyone? Gently remind them that wholeness isn’t about perfection—but about presence, even in the wobble?" },
    { title: "Threshold of Fullness (Listening to the Hush)", prompt: "The moon holds its breath before the peak. In the stillness, is there a Part speaking in whispers—maybe one I’ve silenced to stay strong? Lean in close and let that quiet voice be the one that guides me now?" },
    { title: "The Brightening (Honouring the Build)", prompt: "The moon is almost full, and so is my inner landscape. Are there Parts that have carried quiet burdens to get me here? Pause and say, 'I see you, and I thank you—for your strength, your silence, your steady hold'?" },
    { title: "The Final Approach (Surrender Before the Peak)", prompt: "One breath from fullness. Is there a Part still trying to control how this unfolds? Gently invite it to rest—not by force, but by offering, 'I’ve got us. You don’t have to hold on so tightly any more'?" },
    ...
    { title: "The Turn (Softening the Glow)", prompt: "The moon begins its gentle release. Is there a Part that wants to hold on tight to this peak—afraid of what fades with the light? Offer a steady hand, reminding them that letting go isn’t loss, but trust in the cycle?" },
    { title: "Releasing the Charge (Updating)", prompt: "The moon is turning, and so is the energy. Are there 'Firefighter' Parts still acting from an old threat—holding a picture of danger that’s no longer true? Gently offer a new image: 'Look around. See the light, feel the breath. We’re not there any more. We’re here'?" },
    { title: "Updating the Inner Map", prompt: "The light continues to soften. Is there a Part still braced for a storm that has already passed—holding onto an old picture of danger? Gently offer a new view: 'Look around. Feel the stillness. The threat is gone. We’re here, in this quiet, and we’re safe'?" },
    ...
    { title: "Tending the Quiet", prompt: "The moon is less full now, and the energy is turning inward. I wonder—what’s it like for the Parts who’ve been loud or active? Are they winding down on their own, or is there a part of me that’s unsure how to let go of the charge? Simply ask: 'What do you need to feel safe in this stillness?'" },
    ...
    { title: "Honouring the Hidden", prompt: "The dark is growing, and so is the invitation to listen. Is there a Part that’s been exiled long ago, still holding a story that’s never been told? Gently ask: 'What do you need for me to finally hear you—not to fix, but to witness?'" },
    { title: "Approaching the Dark (Tender Witnessing)", prompt: "The moon is nearly gone, and the inner world feels hushed. Is there a Part carrying an old wound that’s been hidden, not because it wants to stay buried, but because it’s waited so long to be met with kindness? Offer not solutions, but soft presence—just saying, 'I’m here. You don’t have to carry this alone any more'?" },
    { title: "Deepening Stillness (Compassionate Holding)", prompt: "The light is almost gone, and the silence grows. Is there a Part that’s been afraid to speak, not because it’s angry, but because it’s tender—afraid of being too much, or not enough? Simply say: 'You are safe here. Your softness is not weakness. I’ve got you'?" },
    { title: "Threshold of the Dark (Sacred Waiting)", prompt: "We’re nearing the moon’s return to dark. Is there a Part that feels empty, as if something’s missing? Gently remind it: 'This isn’t loss—it’s preparation. The void isn’t empty; it’s full of what’s waiting to be born'?" },
    { title: "On the Edge of Return (Whispering Gratitude)", prompt: "In this deepest quiet, I wonder—what would it feel like to thank the Parts who’ve carried the weight, even when I didn’t know their names? Offer a quiet gratitude: 'Thank you for holding on. I see you now. And I’m here to hold you'?" },
    { title: "In the Quiet (Soft Reassurance)", prompt: "The moon is dark now, and the world feels still. Is there a Part that fears this emptiness, as if stillness means absence? Gently whisper: 'This is not abandonment. This is belonging. You are not alone in the dark—I’m right here with you'?" },
    { title: "Just Before the New (Tending the Embers)", prompt: "The cycle is about to turn. Beneath the silence, is there a Part that’s been waiting—not demanding, just hoping to be seen? Lean in close and say: 'I know you’ve been here all along. Thank you for your patience. Let's begin again, together'?" }
  ];
